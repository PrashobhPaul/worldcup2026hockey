...
REASONS = {
    ...
    'S2E3': "Argentina's only defeat in four matches this tournament is to the Netherlands, and they arrive from beating England 3-1, every goal of it scored by Tomas Domene. India's four matches split the other way: wins over Wales and Pakistan, defeats in both meetings with top-eight opposition, and eleven conceded overall — nearly three a match. Argentina's corner battery against the tournament's most breached top-eight defence favours Los Leones.",
    ...
    'S2H4': "Ireland arrive from the tournament's highest-scoring match, a 7-4 win built on a first-half Lynch hat-trick — the afternoon their finishing finally matched their chances. France are winless in four: two pool draws, a one-goal loss to Belgium, and a Stage 2 defeat to South Africa in which they managed a single goal. Ireland's far sharper finishing favours them.",
}
