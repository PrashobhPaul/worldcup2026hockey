...
REASONS = {
    ...
    'A3': "The Netherlands opened with five against New Zealand, three from open play and two from penalty corners, and conceded once. Argentina's opening win was narrower but cleaner: three scored, none conceded, and all three from open play. One match each is thin evidence and the Dutch scoring is the louder number, but the only clean sheet between them is Argentina's, and with a single match apiece to go on, the defence that has not yet been breached is the firmer ground.",
